        ...
        <div class="page d-flex flex-row flex-column-fluid">
            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                ...
                <div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header"
                    data-kt-sticky-offset="{default: '100px', lg: '200px'}" style="height: 80px">
                    <!--begin::Container-->
                    <div class="container-xxl d-flex flex-grow-1 flex-stack">
                        ...
                        <div class="d-flex align-items-center me-5">
                            ...
                            <a href="{{ url('/') }}">
                                ...
                                <img alt="Logo" src="{{ asset('logo/logo-admin.png') }}"
                        ...
                        <div class="d-flex align-items-center flex-shrink-0">
                            ...
                            <!--begin::Login-->
                            <div class="d-flex align-items-center p-3 p-lg-0 ms-2 me-lg-2">
                                <a href="{{ url('auth/login') }}"
                                    class="btn btn-sm btn-primary fw-bold w-100 w-lg-auto" data-bs-toggle="tooltip"
                                    data-bs-trigger="hover" data-bs-dismiss-="click">
                                    {{-- <img src="{{ asset('themes/assets/media/icons/duotune/ecommerce/ecm001.svg') }}"
                                class="h-25px me-2" /> --}}
                                    Masuk
                                </a>
                            </div>
                            ...
                            <div class="d-flex align-items-center p-3 p-lg-0 ms-2 me-lg-2">
                                <a href="{{ url('auth/register') }}"
                                    class="btn btn-sm btn-secondary fw-bold w-100 w-lg-auto" data-bs-trigger="hover">
                                    Daftar
                                </a>
                            </div>
                            <!--end::Register -->
